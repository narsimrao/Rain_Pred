...
# Website Link: ["https://rain-pred.onrender.com/"](https://rain-pred.onrender.com/)
...
# Model Deployment
* The model is deployed using Flask at Render server at the [link](https://rain-pred.onrender.com/)
